...
contract StarNotary is ERC721 {
    ...
    string public tokenName = "MoonDogeAwesomeStar";
    string public tokenSymbol = "STAR";
    ...
    //Approve transaction
    function approveTransaction(address _spender, uint256 _tokenId) public returns(bool success){
    ...
    function buyStar(uint256 _tokenId) public  payable {
        ...
        //approveTransaction(msg.sender, _tokenId);
    ...
    function lookUptokenIdToStarInfo (uint256 _tokenId) public view returns (string memory) {
        ...
        require(bytes(tokenIdToStarInfo[_tokenId].name).length > 0, "The Star was not found");
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == owner1 || msg.sender == owner2, 
            "Sender must own one of the stars to be exchanged.");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        //1. Check if the sender is the ownerOf(_tokenId)
         require(msg.sender == ownerOf(_tokenId), "Sender must own the star to be transfered.");
